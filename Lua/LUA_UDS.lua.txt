// message from turnip here
// I DIDNT MAKE THIS SCRIPT
// Amperbee/Rapidgame7 did
// okay bye
...
if forcecache then
	...
	// get out you annoying message
	// this is the pig mod and i want it to look presentable without-
	// -someone asking if that random console message was an error
end
for _ix = 1,#fonts do
